...
PER_TEST_TIMEOUTS = {
    ...
    "test_generate_dataset_franka_state.py": 1000,  # This test runs annotation for 10 demos and generation until one succeeds
    "test_generate_dataset_franka_visuomotor.py": 2000,  # This test runs generation until one succeeds
    "test_generate_dataset_gr1t2_nutpour.py": 2000,  # This test runs generation until one succeeds
    "test_generate_dataset_gr1t2_pickplace.py": 2000,  # This test runs generation until one succeeds
